        ...
        <Section>
            <div className="flex justify-between mb-[50px]">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <IconBox icon={"swiper-nav-right icon-angle-small-left cursor-pointer bg-gray-100 p-2 rounded-full text-gray-500 hover:bg-green-200 hover:text-white"} size={24}/> </div>
                </div>
        ...
        <Section>
            <div className="flex justify-between mb-[50px]">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <IconBox icon={"swiper-nav-right2 icon-angle-small-left cursor-pointer bg-gray-100 p-2 rounded-full text-gray-500 hover:bg-green-200 hover:text-white"} size={24}/>
                </div>
            </div>
