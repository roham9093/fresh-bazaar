import {Badge, IconBox, ImageView, ProductCardButton, Rating} from "@/components";
...
export const SimpleProductCard = ({data}: Props) => {
    return (
        ...
        <div className="group border-[1px] border-gray-200 hover:border-green-150 rounded-[10px] hover:shadow-[20px_20px_40px_0_rgba(24,24,24,0.07)] relative p-3 md:p-4 xl:px-5 xl:pb-5 lg:pt-[65px] h-full">
            ...
            <ImageView src={data?.attributes?.thumbnail?.data?.attributes.url} alt={data?.attributes?.title} height={168} width={210} className={"m-auto w-full aspect-[3/2] mb-[28px]"} />
