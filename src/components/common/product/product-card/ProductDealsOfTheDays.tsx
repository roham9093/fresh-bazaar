...
export const ProductDealsOfTheDays = ({data}: Props) => {
    ...
    return (
        <div className="relative h-[438px]">
            <ImageView src={data.attributes.thumbnail?.data?.attributes.url} alt={"product"} width={378} height={335} className="w-full"/>
